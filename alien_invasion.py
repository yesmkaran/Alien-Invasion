...
class AlienInvasion:
	...
	def __init__(self):
		...
		# Initialize the music and sound
		self.bulletSound = pygame.mixer.Sound('sounds/380_gunshot_single-mike-koenig.wav')
		self.hitSound = pygame.mixer.Sound('sounds/punch_or_whack.wav')

		music = pygame.mixer.music.load('sounds/Offensive(mp3).mp3')
